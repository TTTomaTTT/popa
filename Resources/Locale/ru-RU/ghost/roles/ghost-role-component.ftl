...
ghost-role-information-tomatoburger-rules = После перерождения в бургер вы обрели разум, однако сейчас вы не можете кусаться как раньше и вас это не радует. Вы всё также желаете всем смерти, но высказываться об этом стоит аккуратнее, бургер не настолько грозный монстр.
